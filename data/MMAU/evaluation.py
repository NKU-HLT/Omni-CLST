...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Process benchmark JSONL and calculate accuracy.")
    parser.add_argument('--input', type=str, required=True, help='Path to input JSONL file to be evaluated')
